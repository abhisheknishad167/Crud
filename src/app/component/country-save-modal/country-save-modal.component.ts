...
export class CountrySaveModalComponent {
  ...
  constructor(private primengConfig: PrimeNGConfig, public ref: DynamicDialogRef, public config: DynamicDialogConfig) {
    ...
    this.countryForm = new FormGroup({
      ...
      email: new FormControl(this.country.email), // Adding email field
      dob: new FormControl(this.country.dob), // Adding dob field
      country: new FormControl(this.country.country), // Adding country field
